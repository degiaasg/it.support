<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">{{ __('Tiket Maintenance') }}</h2>
            <a href="{{ route('tickets.create') }}" class="bg-blue-500 dark:bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded text-sm">+ Buat Tiket</a>
        </div>
    </x-slot>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm dark:shadow-gray-900 sm:rounded-lg p-6 mb-4">
                <form method="GET" class="flex gap-4 items-end">
                    <div>
                        ...
                        <select name="status" class="rounded-md border-gray-300 dark:border-gray-600 text-sm" onchange="this.form.submit()">
                    ...
                    <div>
                        ...
                        <select name="priority" class="rounded-md border-gray-300 dark:border-gray-600 text-sm" onchange="this.form.submit()">
                            <option value="">Semua</option>
                    ...
                    <table class="min-w-full text-sm">
                        ...
                        <tbody>
                            ...
                            <tr class="border-b hover:bg-gray-50 dark:hover:bg-gray-700">
                                ...
                                <td class="py-3 px-2 text-center">
                                    <a href="{{ route('tickets.show', $ticket) }}" class="text-blue-600 dark:text-blue-400 hover:underline text-xs">Detail</a>
                                </td>
                            </tr>
                            @empty
                            <tr>
                                <td colspan="7" class="py-6 text-center text-gray-500 dark:text-gray-400">Belum ada tiket.</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
