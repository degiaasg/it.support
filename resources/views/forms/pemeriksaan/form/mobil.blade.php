                        ...
                        <div class="mb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="imei" class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 text-sm" value="{{ old('imei') }}">
                                </div>
                            </div>
                        </div>

                        {{-- Pemeriksaan Hardware Mobile --}}
                        <div class="mb-6">
                            ...
                            <div class="overflow-x-auto">
                                <table class="min-w-full text-sm">
                                    ...
                                    <tbody>
                                        @php
                                        $items = ['Layar/Touchscreen', 'Baterai', 'Charging Port', 'Speaker/Mic', 'Camera', 'Tombol Fisik', 'Sensor (Gyro/Accel)', 'Fingerprint', 'Connectivity (WIFI/BT)', 'SIM Card Slot'];
                                        @endphp
