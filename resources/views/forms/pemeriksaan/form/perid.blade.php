                    ...
                    <form action="{{ route('forms.pemeriksaan.store') }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Tipe Peripheral</label>
                                    <select name="tipe_peripheral" class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 text-sm">
                        ...
                        <div class="mb-6">
                            <h4 class="font-semibold text-gray-800 dark:text-gray-200 mb-3 pb-2 border-b">Pemeriksaan Peripheral</h4>
                            <div class="overflow-x-auto">
                                <table class="min-w-full text-sm">
                                    ...
                                    <tbody>
                                        @php
                                        $items = ['Power Cable', 'Data Cable', 'Physical Condition', 'Button/Control', 'Indicator Light', 'Connectivity Port', 'Driver/Software'];
                                        @endphp
                                        @foreach($items as $item)
                                        <tr class="border-b">
                                            <td class="py-2 px-3">{{ $item }}</td>
                                            <td class="py-2 px-3 text-center">
                                                <select name="per_{{ Str::slug($item, '_') }}" class="rounded border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 text-xs">
                                                    <option value="">--</option>
                                            ...
                                            <td class="py-2 px-3">
                                                <input type="text" name="per_{{ Str::slug($item, '_') }}_ket" class="w-full rounded border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 text-xs" placeholder="Keterangan">
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
