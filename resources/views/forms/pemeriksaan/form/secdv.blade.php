            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm dark:shadow-gray-900 sm:rounded-lg">
                <div class="p-6">
                    <form action="{{ route('forms.pemeriksaan.store') }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="lokasi" class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 text-sm" value="{{ old('lokasi') }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-6">
                            <h4 class="font-semibold text-gray-800 dark:text-gray-200 mb-3 pb-2 border-b">Pemeriksaan Perangkat Keamanan</h4>
                            <div class="overflow-x-auto">
                                <table class="min-w-full text-sm">
                                    ...
                                    <tbody>
                                        @php
                                        $items = ['Camera/Lensa', 'IR LED', 'Housing', 'Cable Connection', 'Power Supply', 'Mounting Bracket', 'Recording/NVR', 'Remote Access'];
                                        @endphp
                                        @foreach($items as $item)
                                        <tr class="border-b">
                                            <td class="py-2 px-3">{{ $item }}</td>
                                            <td class="py-2 px-3 text-center">
                                                <select name="sec_{{ Str::slug($item, '_') }}" class="rounded border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 text-xs">
                                                    <option value="">--</option>
                                            ...
                                            <td class="py-2 px-3">
                                                <input type="text" name="sec_{{ Str::slug($item, '_') }}_ket" class="w-full rounded border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 text-xs" placeholder="Keterangan">
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
