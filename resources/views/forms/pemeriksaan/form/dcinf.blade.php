            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm dark:shadow-gray-900 sm:rounded-lg">
                <div class="p-6">
                    <form action="{{ route('forms.pemeriksaan.store') }}" method="POST">
                        ...
                        {{-- Pemeriksaan DC Infrastructure --}}
                        <div class="mb-6">
                            <h4 class="font-semibold text-gray-800 dark:text-gray-200 mb-3 pb-2 border-b">Pemeriksaan Komponen</h4>
                            <div class="overflow-x-auto">
                                <table class="min-w-full text-sm">
                                    ...
                                    <tbody>
                                        @php
                                        $items = ['Power Supply / UPS', 'Cooling / AC', 'Server Rack', 'Cabling', 'Fire Suppression', 'Monitoring System', 'Temperature Sensor', 'CCTV DC', 'Access Control', 'PDU (Power Distribution Unit)'];
                                        @endphp
                                        @foreach($items as $item)
                                        <tr class="border-b">
                                            <td class="py-2 px-3">{{ $item }}</td>
                                            <td class="py-2 px-3 text-center">
                                                <select name="dc_{{ Str::slug($item, '_') }}" class="rounded border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 text-xs">
                                                    <option value="">--</option>
                                            ...
                                            <td class="py-2 px-3">
                                                <input type="text" name="dc_{{ Str::slug($item, '_') }}_ket" class="w-full rounded border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 text-xs" placeholder="Keterangan">
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
