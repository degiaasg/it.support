                    ...
                    <table class="min-w-full text-sm">
                        <thead>
                            <tr class="border-b">
                                ...
                                <th class="text-left py-3 px-2">Pengembali</th>
                                <th class="text-left py-3 px-2">Tgl. Kembali</th>
                                <th class="text-left py-3 px-2">Kondisi</th>
                                <th class="text-left py-3 px-2">Keterangan</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr class="border-b hover:bg-gray-50 dark:hover:bg-gray-700">
                                ...
                                <td class="py-3 px-2">{{ $item->pengembali }}</td>
                                <td class="py-3 px-2">{{ $item->tanggal_kembali }}</td>
                                <td class="py-3 px-2">{{ $item->kondisi }}</td>
                                <td class="py-3 px-2 text-gray-500">{{ $item->keterangan ?? '-' }}</td>
                            </tr>
                            @empty
                            <tr>
