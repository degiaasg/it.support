                    ...
                    <table class="min-w-full text-sm">
                        <thead>
                            <tr class="border-b">
                                ...
                                <th class="text-left py-3 px-2">Peminjam</th>
                                <th class="text-left py-3 px-2">Tgl. Pinjam</th>
                                <th class="text-left py-3 px-2">Rencana Kembali</th>
                        ...
                        <tbody>
                            ...
                            <tr class="border-b hover:bg-gray-50 dark:hover:bg-gray-700">
                                ...
                                <td class="py-3 px-2">{{ $item->peminjam }}</td>
                                <td class="py-3 px-2">{{ $item->tanggal_pinjam }}</td>
                                <td class="py-3 px-2">{{ $item->tanggal_rencana_kembali }}</td>
                                <td class="py-3 px-2 text-center">
                                    <span class="px-2 py-1 text-xs rounded {{ $item->status === 'dipinjam' ? 'bg-yellow-100 dark:bg-yellow-900/50 text-yellow-800 dark:text-yellow-300' : 'bg-green-100 dark:bg-green-900/50 text-green-800 dark:text-green-300' }}">
                                        {{ ucfirst($item->status) }}
                                    </span>
                                </td>
                            </tr>
