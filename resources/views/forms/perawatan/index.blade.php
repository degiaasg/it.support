                    ...
                    <table class="min-w-full text-sm">
                        <thead>
                            <tr class="border-b">
                                ...
                                <th class="text-left py-3 px-2">Petugas</th>
                        ...
                        <tbody>
                            ...
                            <tr class="border-b hover:bg-gray-50 dark:hover:bg-gray-700">
                                ...
                                <td class="py-3 px-2">{{ $item->tanggal_perawatan }}</td>
                                <td class="py-3 px-2">{{ $item->jenis_perawatan }}</td>
                                <td class="py-3 px-2">{{ $item->petugas }}</td>
                                <td class="py-3 px-2 text-right">Rp {{ number_format($item->biaya, 0, ',', '.') }}</td>
                            </tr>
                            @empty
                            <tr>
