<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <div class="text-sm text-gray-500 me-4">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('devices.index')" :active="request()->routeIs('devices.*')">{{ __('Perangkat') }}</x-responsive-nav-link>
            <x-responsive-nav-link :href="route('tickets.index')" :active="request()->routeIs('tickets.*')">{{ __('Tiket') }}</x-responsive-nav-link>
            @if(auth()->user()->role !== 'user')
            <x-responsive-nav-link :href="route('categories.index')" :active="request()->routeIs('categories.*')">{{ __('Kategori') }}</x-responsive-nav-link>
            <x-responsive-nav-link :href="route('maintenance-logs.index')" :active="request()->routeIs('maintenance-logs.*')">{{ __('Maintenance') }}</x-responsive-nav-link>
            <x-responsive-nav-link :href="route('spare-parts.index')" :active="request()->routeIs('spare-parts.*')">{{ __('Spare Part') }}</x-responsive-nav-link>
