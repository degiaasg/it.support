<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">{{ __('Detail Maintenance Log') }}</h2>
    </x-slot>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                <table class="min-w-full text-sm">
                    ...
                    <tr class="border-b">
                        ...
                        <td class="py-2"><a href="{{ route('devices.show', $maintenanceLog->device) }}" class="text-blue-600 hover:underline">{{ $maintenanceLog->device->name }}</a></td>
                    </tr>
                    <tr class="border-b">
                    ...
                    <tr class="border-b">
                        ...
                        <td class="py-2">
                            ...
                            <a href="{{ route('tickets.show', $maintenanceLog->ticket) }}" class="text-blue-600 hover:underline">{{ $maintenanceLog->ticket->title }}</a>
                            @else -
                            @endif
                        </td>
                    </tr>
                ...
                <div class="mt-4 flex gap-2">
                    <a href="{{ route('maintenance-logs.index') }}" class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded text-sm">Kembali</a>
                    <a href="{{ route('maintenance-logs.edit', $maintenanceLog) }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded text-sm">Edit</a>
                </div>
            </div>
        </div>
    </div>
